  ...
  <div class="d-inline-block mx-xs-auto text-center text-md-left col-md-4 offset-md-1 home-panel">
    <div class="home-register default-card">
      <form method="POST" action="{{ route('register') }}">
        ...
        <input class="w-75 default-input" name="email" placeholder="Email" type="email" required/>
        <input class="w-75 default-input" name="password" placeholder="Password" type="password" required/>
